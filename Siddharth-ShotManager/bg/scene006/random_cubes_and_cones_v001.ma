...
//Name: random_cubes_and_cones_v001.ma
//Last modified: Thu, Jun 11, 2015 03:27:35 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	...
	setAttr ".rpt" -type "double3" -1.145554801854998e-014 1.579658079259904e-015 3.559896798268116e-016 ;
...
createNode transform -n "pCylinder8" -p "null1";
	...
	setAttr ".r" -type "double3" 15.496212157692893 163.74174153378991 284.89085527726002 ;
...
createNode transform -n "pCylinder10" -p "null1";
	setAttr ".t" -type "double3" 6.3987045836228731 14.558696402433895 -3.9465075110878449 ;
	setAttr ".r" -type "double3" 330.0740140439998 240.63533108675696 78.895039661426338 ;
createNode transform -n "pCylinder11" -p "null1";
	setAttr ".t" -type "double3" -3.9754739042647542 19.940141842154503 -4.0589900758770403 ;
	setAttr ".r" -type "double3" 302.28297351080801 104.34484549983976 24.266663372677129 ;
...
createNode transform -n "pCylinder15" -p "null1";
	setAttr ".t" -type "double3" -5.1965102013690023 0.38704096758470202 3.1821561355800299 ;
...
createNode transform -n "pCylinder20" -p "null1";
	setAttr ".t" -type "double3" -9.6318406954306504 7.9329182302871102 -7.0786019904176234 ;
...
createNode transform -n "pCylinder22" -p "null1";
	...
	setAttr ".r" -type "double3" 338.38046977163901 56.375494210753715 357.56190366460226 ;
createNode transform -n "pCylinder23" -p "null1";
	setAttr ".t" -type "double3" -3.1572672683989929 18.894770344461573 1.7212757238636185 ;
	setAttr ".r" -type "double3" 307.8764796032911 127.7684792807205 76.444393562020053 ;
createNode transform -n "pCylinder24" -p "null1";
	setAttr ".t" -type "double3" 0.95826591988793908 16.44542220231893 -0.88081258406096363 ;
	setAttr ".r" -type "double3" 137.79789558235981 313.7600097978563 225.97466082190951 ;
...
createNode transform -n "pCylinder27" -p "null1";
	setAttr ".t" -type "double3" -8.5233754428067776 1.3038189090468522 0.83750628066248811 ;
...
createNode transform -n "pCylinder28" -p "null1";
	setAttr ".t" -type "double3" -3.8668919816599776 12.033516048693279 4.7561174982001564 ;
	setAttr ".r" -type "double3" 127.8576239832893 146.61541389791816 71.962145794770947 ;
createNode transform -n "pCylinder29" -p "null1";
	setAttr ".t" -type "double3" 1.4968108150028121 2.2944834622683041 -1.3400172338398608 ;
...
createNode transform -n "pCylinder30" -p "null1";
	setAttr ".t" -type "double3" -2.1123229516935815 6.6189912119596332 9.1299067316329552 ;
...
createNode transform -n "pCylinder32" -p "null1";
	setAttr ".t" -type "double3" 7.1888584714920931 7.7045007407973651 -1.584987855981602 ;
...
createNode transform -n "pCylinder33" -p "null1";
	setAttr ".t" -type "double3" -1.2718524254873014 19.60968335537618 -7.2887931462164515 ;
...
createNode transform -n "pCylinder34" -p "null1";
	setAttr ".t" -type "double3" -7.24507471106977 11.41356291515924 9.3502179905182317 ;
	setAttr ".r" -type "double3" 253.74779853387594 180.13623987049044 13.655870922134936 ;
createNode transform -n "pCylinder35" -p "null1";
	...
	setAttr ".r" -type "double3" 141.74656621554351 197.75550990724585 78.613284100976443 ;
createNode transform -n "pCylinder36" -p "null1";
	...
	setAttr ".r" -type "double3" 39.323231747763629 348.7196479512267 121.11793028707758 ;
...
createNode transform -n "pCylinder38" -p "null1";
	setAttr ".t" -type "double3" 6.4853392015394178 13.626491360930872 -9.1988702894288146 ;
...
createNode transform -n "pCylinder40" -p "null1";
	setAttr ".t" -type "double3" 1.6774862291455437 2.5181849708176407 4.7824884801376832 ;
...
createNode transform -n "pCylinder46" -p "null1";
	setAttr ".t" -type "double3" -1.8630812218288393 12.801407386090268 2.4750999424977245 ;
...
createNode transform -n "pCylinder53" -p "null2";
	setAttr ".t" -type "double3" 0.78408782737432492 14.695778803201929 2.5437645755122578 ;
...
createNode transform -n "pCylinder55" -p "null2";
	...
	setAttr ".r" -type "double3" 73.428016083945465 246.74711002320419 21.092205198050241 ;
...
createNode transform -n "pCylinder57" -p "null2";
	...
	setAttr ".r" -type "double3" 202.13111153220092 173.45823337273657 52.789506228544035 ;
...
createNode transform -n "pCylinder60" -p "null2";
	setAttr ".t" -type "double3" -2.4762866272575623 13.220147620610051 -5.0628371979990678 ;
...
createNode transform -n "pCylinder64" -p "null2";
	setAttr ".t" -type "double3" -9.0421730192627017 10.728594606647947 5.8493691992947205 ;
...
createNode transform -n "pCylinder66" -p "null2";
	setAttr ".t" -type "double3" 1.6588419676986206 1.9845313452012017 -1.2184616871883041 ;
...
createNode transform -n "pCylinder67" -p "null2";
	...
	setAttr ".r" -type "double3" 19.614080923496861 269.8117053053677 11.717744677986175 ;
createNode transform -n "pCylinder68" -p "null2";
	setAttr ".t" -type "double3" 3.3988949230929215 9.0194234686406656 1.0535629694292601 ;
	setAttr ".r" -type "double3" 80.56737024458441 44.817796586699203 246.66436002142305 ;
createNode transform -n "pCylinder69" -p "null2";
	...
	setAttr ".r" -type "double3" 233.41190869773644 240.61566499045006 36.218532566056723 ;
createNode transform -n "pCylinder70" -p "null2";
	...
	setAttr ".r" -type "double3" 153.30460973527883 98.490506057224124 22.082368784413905 ;
createNode transform -n "pCylinder71" -p "null2";
	...
	setAttr ".r" -type "double3" 138.617951831803 321.90385120462287 50.411254080246643 ;
createNode transform -n "pCylinder72" -p "null2";
	setAttr ".t" -type "double3" 2.1603875774029255 5.6103952341332741 -1.1997842745351337 ;
...
createNode transform -n "pCylinder73" -p "null2";
	setAttr ".t" -type "double3" 1.9022409110448704 17.153336581385435 4.3430133706393388 ;
...
createNode transform -n "pCylinder74" -p "null2";
	...
	setAttr ".r" -type "double3" 304.85310901115423 224.46982884207023 212.18459946409081 ;
createNode transform -n "pCylinder75" -p "null2";
	...
	setAttr ".r" -type "double3" 123.19228446136682 13.155104815526949 348.0722967496784 ;
createNode transform -n "pCylinder76" -p "null2";
	...
	setAttr ".r" -type "double3" 182.52829104935705 345.08946980801261 272.93707208019367 ;
...
createNode transform -n "pCylinder78" -p "null2";
	setAttr ".t" -type "double3" 1.4150255823465852 10.231401129774165 8.9769572635254704 ;
...
createNode transform -n "pCylinder79" -p "null2";
	setAttr ".t" -type "double3" 4.603854477340894 12.91815372684272 2.4269071861935174 ;
	setAttr ".r" -type "double3" 272.41733090112604 232.49630846062055 112.6736100027782 ;
...
createNode transform -n "pCylinder83" -p "null2";
	setAttr ".t" -type "double3" 3.9465457706819138 19.549921065280827 6.6713915070023582 ;
	setAttr ".r" -type "double3" 324.22847670367906 255.97281943899193 16.47957122956921 ;
createNode transform -n "pCylinder84" -p "null2";
	setAttr ".t" -type "double3" 2.4232756728564393 2.3860500620073677 7.5761508095891932 ;
...
createNode transform -n "pCylinder89" -p "null2";
	...
	setAttr ".r" -type "double3" 241.54919149471519 171.69980815799121 128.43972922123447 ;
createNode transform -n "pCylinder90" -p "null2";
	...
	setAttr ".r" -type "double3" 272.58468131689932 235.80602275667093 27.811505863141285 ;
...
createNode transform -n "pCylinder92" -p "null2";
	setAttr ".t" -type "double3" -7.8658519510034477 13.24507398154071 -2.5873749427140802 ;
...
createNode transform -n "pCylinder95" -p "null2";
	setAttr ".t" -type "double3" -6.6027033681377016 15.12627461098336 7.1638050902369059 ;
...
createNode transform -n "pCylinder98" -p "null2";
	setAttr ".t" -type "double3" 6.8999317104065057 3.5272019075181227 -3.8923612236675802 ;
	setAttr ".r" -type "double3" 252.5848804828664 319.32140036852763 345.69701064141469 ;
createNode transform -n "pCylinder99" -p "null2";
	setAttr ".t" -type "double3" 7.1700563445550394 14.780600071110827 6.256389066103015 ;
...
// End of random_cubes_and_cones_v001.ma
